...
produces expected game state changes. Uses threading to launch the actual
BreakoutGame and direct InputManager callback invocation to simulate input.
"""
...
def breakout_game_threaded():
    """Fixture: Launch BreakoutGame in thread and return game reference.
...
class TestBreakoutInputHandling:
    ...
    def test_paddle_moves_left_on_arrow_key(self, breakout_game_threaded):
        ...
        game.engine.input_manager.on_key_press('Left', 0)
        game.engine.input_manager.update()
        time.sleep(0.05)  # Let game update
    ...
    def test_paddle_moves_left_on_a_key(self, breakout_game_threaded):
        ...
        # Inject 'a' key
        game.engine.input_manager.on_key_press('a', 0)
        game.engine.input_manager.update()
        time.sleep(0.05)
    ...
    def test_paddle_moves_right_on_arrow_key(self, breakout_game_threaded):
        ...
        game.engine.input_manager.on_key_press('Right', 0)
        game.engine.input_manager.update()
        time.sleep(0.05)
    ...
    def test_paddle_moves_right_on_d_key(self, breakout_game_threaded):
        ...
        # Inject 'd' key
        game.engine.input_manager.on_key_press('d', 0)
        game.engine.input_manager.update()
        time.sleep(0.05)
    ...
    def test_paddle_cannot_move_past_left_boundary(self, breakout_game_threaded):
        ...
        # Move paddle all the way left by sending multiple left presses
        for _ in range(20):
            game.engine.input_manager.on_key_press('Left', 0)
            game.engine.input_manager.update()
            time.sleep(0.02)
    ...
    def test_paddle_cannot_move_past_right_boundary(self, breakout_game_threaded):
        ...
        # Move paddle all the way right by sending multiple right presses
        for _ in range(20):
            game.engine.input_manager.on_key_press('Right', 0)
            game.engine.input_manager.update()
            time.sleep(0.02)
...
class TestBreakoutCollisions:
    ...
    def test_ball_bounces_off_top_wall(self, breakout_game_threaded):
        ...
        initial_vy = game.ball.velocity.y
    ...
    def test_ball_bounces_off_side_walls(self, breakout_game_threaded):
    ...
    def test_ball_is_lost_when_below_screen(self, breakout_game_threaded):
    ...
    def test_ball_resets_after_loss(self, breakout_game_threaded):
    ...
    def test_ball_bounces_off_paddle(self, breakout_game_threaded):
    ...
    def test_ball_bounces_off_brick(self, breakout_game_threaded):
    ...
    def test_brick_removed_after_collision(self, breakout_game_threaded):
    ...
    def test_ball_speed_increases_after_brick_hit(self, breakout_game_threaded):
    ...
    def test_multiple_collisions_in_sequence(self, breakout_game_threaded):
...
class TestBreakoutGameState:
    ...
    def test_score_increments_on_brick_collision(self, breakout_game_threaded):
    ...
    def test_score_tracks_multiple_bricks(self, breakout_game_threaded):
    ...
    def test_lives_decrement_on_ball_loss(self, breakout_game_threaded):
    ...
    def test_game_over_when_lives_reach_zero(self, breakout_game_threaded):
    ...
    def test_level_complete_when_all_bricks_destroyed(self, breakout_game_threaded):
    ...
    def test_game_starts_in_playing_state(self, breakout_game_threaded):
    ...
    def test_game_state_persists_across_frames(self, breakout_game_threaded):
